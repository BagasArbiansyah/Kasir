                ...
                <form method="POST" action="/admin">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('status_order') is-invalid @enderror" id="status_order" placeholder="Masukkan Status Order" name="status_order" value="{{ old('status_order')}}">
                            {{-- @error('status_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror --}}
                        </div>
